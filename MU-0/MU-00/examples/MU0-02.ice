{
  ...
  "design": {
    ...
    "graph": {
      "blocks": [
        {
          "id": "ac66caa7-aa90-4f6b-a177-640e4d860149",
          "type": "basic.output",
          "data": {
            "name": "LED",
            "range": "[3:0]",
        ...
        {
          "id": "95e4f0d1-fd5a-45b1-ae50-911da8d1d212",
          "type": "basic.code",
          "data": {
            "code": "assign inst = d[3:0];",
            "params": [],
            "ports": {
              "in": [
                {
        ...
        {
          "id": "dc08bd98-b9c0-4e0b-a333-a0e05b0ddc8e",
          "type": "basic.info",
          "data": {
            "info": "Mostrar los 4 bits más bajos  \nde la instrucción en los LEDs",
            "readonly": true
          },
          "position": {
            "x": 1216,
        ...
        {
          "id": "7a357477-4f32-42b1-b4c0-99d5e55a225e",
      ...
      "wires": [
        ...
        },
        {
          ...
          "target": {
            "block": "95e4f0d1-fd5a-45b1-ae50-911da8d1d212",
            "port": "d"
          },
          "size": 32
        },
        {
          ...
          "target": {
            "block": "ac66caa7-aa90-4f6b-a177-640e4d860149",
            "port": "in"
          },
          "size": 4
        },
        ...
        {
          "source": {
            "block": "7a357477-4f32-42b1-b4c0-99d5e55a225e",
